  ...
  return (
    <div ref={rootRef} className="relative shrink-0">
      <button
        ...
        className="inline-flex items-center gap-2 h-11 rounded-lg border border-white/20 bg-white/10 px-3 text-sm text-white font-semibold transition hover:border-white/50 hover:bg-white/20"
            ...
            {languageOptions.map((opt) => (
              <li key={opt.code}>
                <button
                  ...
                  className={`w-full flex items-center gap-3 px-4 py-3 text-sm font-medium transition hover:bg-white/10 ${
