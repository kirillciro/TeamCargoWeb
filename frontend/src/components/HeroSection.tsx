        ...
        <div ref={revealRef} className="reveal">
          ...
          <div className="hero-ctas mb-4 sm:mb-7 w-full">
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 flex-1 py-3 sm:py-3.5 border border-white/55 bg-black/50 hover:border-white/40 hover:bg-black/60 text-white/20 font-bold rounded-xl transition-all text-sm sm:text-[0.92rem] tracking-wide"
            >
