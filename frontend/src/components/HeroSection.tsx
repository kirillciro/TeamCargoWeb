        ...
        <div ref={revealRef} className="reveal">
          ...
          <div className="hero-ctas mb-4 sm:mb-7 w-full">
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 flex-1 py-3 sm:py-3.5 border border-white/15 bg-black/10 hover:border-white/40 hover:bg-black/60 text-white/60 font-bold rounded-xl transition-all text-sm sm:text-[0.92rem] tracking-wide"
            >
